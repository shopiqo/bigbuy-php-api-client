...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.bigbuy.eu';
    ...
    {
        $report  = 'PHP SDK (Efsa\Client\Bigbuy) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: v202102' . PHP_EOL;
